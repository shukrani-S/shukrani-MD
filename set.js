...
// ✅ Hakikisha DATABASE_URL ipo
if (!DATABASE_URL || DATABASE_URL.trim() === '') {
    console.error("❌ DATABASE_URL haijapatikana. Tafadhali iweke kwenye Render env au set.env");
    process.exit(1); // simamisha bot ili kuepuka makosa makubwa
}
...
fs.watchFile(fichier, () => {
    ...
    console.log(`♻️ Mabadiliko kwenye ${__filename}`);
